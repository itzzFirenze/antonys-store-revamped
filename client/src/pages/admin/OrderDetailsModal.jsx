...
const OrderDetailsModal = ({ isOpen, closeModal, orderId }) => {
   ...
   }, [order?.productId, order?.userId, dispatch]);
      ...
      return (
         <>
            ...
            <div className="space-y-2">
               ...
               <p>
                  <span className="font-semibold">Price:</span> <span className="font-[inter]">₹</span>{product.price}
   ...
   if (loading) {
      return (
         <div className="fixed inset-0 z-50 flex items-start justify-center bg-black bg-opacity-50 overflow-y-auto">
            <div className="relative w-full max-w-4xl bg-white rounded-lg p-4 my-4 mx-2">
      ...
      return (
         <div className="fixed inset-0 z-50">
            ...
            <div className="fixed inset-0 flex items-start justify-center">
               <div className="w-full max-w-4xl bg-white rounded-lg p-4 m-4">
                  <div className="text-red-500">
   ...
   return (
      <div className="fixed inset-0 z-50">
         ...
         <div className="fixed inset-0 flex items-start justify-center pointer-events-none">
            <div className="w-full max-w-4xl bg-white rounded-lg shadow my-4 mx-2 pointer-events-auto flex flex-col max-h-[calc(100vh-2rem)]">
               {/* Modal Header */}
               <div className="flex-shrink-0 flex justify-between items-center p-3 sm:p-4 border-b bg-white rounded-t-lg">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                     ...
                     <div>
                        ...
                        <div className="space-y-2 sm:space-y-3">
                           ...
                           {userError && <p>Error loading user details: {userError}</p>}
                           {user && (
                              <>
                                 <p>
                                    <span className="font-semibold">Customer ID:</span> {user._id}
                                 </p>
                                 <p>
               ...
               {/* Modal Footer */}
               <div className="flex-shrink-0 flex justify-end p-3 sm:p-4 border-t bg-white rounded-b-lg">
                  <button
                     type="button"
                     onClick={handleDeleteClick}
                     className="text-gray-100 bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 mr-2"
                  >
                     Delete Order
                  </button>
                  <button
